...
import data from "@/content/niveles/secundaria.json";
...
const ACC = {
  ...
  btnCls:  "bg-deep-blue text-white hover:bg-ink shadow-md shadow-deep-blue/20",
};
...
export function SecundariaPage() {
  ...
  return (
    <main>
      ...
      {/* ══════════════════════════════════════════════════════════════
          HERO
      ══════════════════════════════════════════════════════════════ */}
      <section className="relative bg-warm-white overflow-hidden" aria-label="Secundaria">
        <div className="absolute -top-40 -right-40 w-[640px] h-[640px] rounded-full bg-deep-blue/[0.05] pointer-events-none" aria-hidden="true" />
        <div className="absolute bottom-0 left-0 w-80 h-80 translate-y-1/3 -translate-x-1/3 rounded-full bg-deep-blue/[0.04] pointer-events-none" aria-hidden="true" />
            ...
            <div className="lg:col-span-6 lg:-mr-8 xl:-mr-14">
              <div className="relative h-72 sm:h-96 lg:h-[580px] rounded-3xl overflow-hidden shadow-2xl shadow-ink/10">
                {data.heroImage ? (
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-deep-blue via-deep-blue/80 to-brand-blue/40" />
                )}
      ...
      {/* ══════════════════════════════════════════════════════════════
          PROGRAMA BILINGÜE — image left, content right
      ══════════════════════════════════════════════════════════════ */}
      ...
      {/* ══════════════════════════════════════════════════════════════
          PROYECTOS ESPECIALES — Sección firma de Secundaria
          border-t-2 usado UNA SOLA VEZ en esta página
      ══════════════════════════════════════════════════════════════ */}
      <SectionContainer id="proyectos" className="bg-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-0">
          {data.etapaItems.map((item, i) => (
            <div key={i} className="border-t-2 border-deep-blue pt-7 pb-8 pr-4">
          ...
          <div>
            ...
            <div className="space-y-4">
              {data.horarios.map((h, i) => (
                <div key={i} className={cn("flex items-start gap-4 rounded-xl p-4 border", ACC.light, "border-deep-blue/20")}>
      ...
      <section id="contacto-nivel" aria-label="Contáctanos" className="relative bg-deep-blue overflow-hidden">
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-16 sm:py-24 mx-auto max-w-xl text-center">
          <div className="h-0.5 w-8 bg-deep-blue/60 rounded-full mx-auto mb-8" style={{ backgroundColor: "#2563eb" }} aria-hidden="true" />
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className={cn(
                ...
                "hover:bg-brand-blue/80 hover:shadow-xl active:scale-[0.97]",
